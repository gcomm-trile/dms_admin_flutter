...
class InventoryTransferNewContentDesktop extends StatelessWidget {
  ...
  InventoryTransferNewController controller = Get.find();
  InventoryTransferNewContentDesktop(
      {Key key, @required this.id, this.onNavigationChanged})
      : super(key: key);
  Widget build(BuildContext context) {
    return Expanded(child: _buildBodySection(context));
  }

      ...
      child: Row(
        children: [
          ...
          Container(
            width: 90,
            child: Text(
              data.refDocumentNote.isEmpty ? '--' : data.refDocumentNote,
              style: TextStyle(
                color: Colors.black,
              ),
            ),
          ...
          Container(
            ...
            child: Center(
              child: LinearPercentIndicator(
                ...
                percent: data.totalImportedQty * 1.0 / data.totalOrderQty * 1.0,
                animateFromLastPercent: true,
                center: Text(
                  '${data.totalImportedQty.toString()}/${data.totalOrderQty.toString()}',

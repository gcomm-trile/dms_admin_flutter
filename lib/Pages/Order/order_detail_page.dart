...
class _OrderDetailPageState extends State<OrderDetailPage> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Container(
                child: Text(data.exportedStockId == kDefaultGuildId
                    ? 'Chưa có kho xuất'
                    : data.exportedStockName),
              ),
              InkWell(
                onTap: () => _showPopupSearchStock(context),
                child: Container(
          ...
          return AlertDialog(
            content: StockSearchPage(
              savedData: (selectedStock) {
                setState(() {
                  data.exportedStockId = selectedStock.id;
                  data.exportedStockName = selectedStock.name;
                });
              },
            ),
          );
  ...
  _approved() {
    if (data.exportedStockId == kDefaultGuildId) {
    ...
    API_HELPER
        .postDuyetXuatDonHang(widget.order_id, data.exportedStockId)
        .then((value) {
      if (value.isEmpty) {
